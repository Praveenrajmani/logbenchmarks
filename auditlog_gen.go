...
func (z *AuditLog) Msgsize() (s int) {
	s = 3 + 8 + msgp.StringPrefixSize + len(z.Version) + 13 + msgp.StringPrefixSize + len(z.DeploymentID) + 5 + msgp.TimeSize + 6 + msgp.StringPrefixSize + len(z.Event) + 5 + msgp.StringPrefixSize + len(z.Type) + 8 + msgp.StringPrefixSize + len(z.Trigger) + 4 + 1 + 5 + msgp.StringPrefixSize + len(z.API.Name) + 7 + msgp.StringPrefixSize + len(z.API.Bucket) + 7 + msgp.StringPrefixSize + len(z.API.Object) + 8 + msgp.ArrayHeaderSize
	for za0001 := range z.API.Objects {
	...
	s += 7 + msgp.StringPrefixSize + len(z.API.Status) + 11 + msgp.IntSize + 3 + msgp.Int64Size + 3 + msgp.Int64Size + 10 + msgp.Int64Size + 16 + msgp.StringPrefixSize + len(z.API.TimeToFirstByte) + 20 + msgp.StringPrefixSize + len(z.API.TimeToFirstByteInNS) + 15 + msgp.StringPrefixSize + len(z.API.TimeToResponse) + 19 + msgp.StringPrefixSize + len(z.API.TimeToResponseInNS) + 11 + msgp.StringPrefixSize + len(z.RemoteHost) + 10 + msgp.StringPrefixSize + len(z.RequestID) + 10 + msgp.StringPrefixSize + len(z.UserAgent) + 12 + msgp.StringPrefixSize + len(z.ReqPath) + 12 + msgp.StringPrefixSize + len(z.ReqHost) + 14 + msgp.MapHeaderSize
	if z.ReqClaims != nil {
		for za0002, za0003 := range z.ReqClaims {
			_ = za0003
...
// DecodeMsg implements msgp.Decodable
func (z *AuditLogList) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
	...
	for zb0001 > 0 {
		...
		case "entries":
			...
			if cap(z.Entries) >= int(zb0002) {
				...
				z.Entries = make([]AuditLog, zb0002)
			}
...
// EncodeMsg implements msgp.Encodable
func (z *AuditLogList) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "entries"
...
// MarshalMsg implements msgp.Marshaler
func (z *AuditLogList) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "entries"
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *AuditLogList) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *AuditLogList) Msgsize() (s int) {
...
func (z *AuditLogTuple) Msgsize() (s int) {
	s = 3 + msgp.StringPrefixSize + len(z.Version) + msgp.StringPrefixSize + len(z.DeploymentID) + msgp.TimeSize + msgp.StringPrefixSize + len(z.Event) + msgp.StringPrefixSize + len(z.Type) + msgp.StringPrefixSize + len(z.Trigger) + 1 + 5 + msgp.StringPrefixSize + len(z.API.Name) + 7 + msgp.StringPrefixSize + len(z.API.Bucket) + 7 + msgp.StringPrefixSize + len(z.API.Object) + 8 + msgp.ArrayHeaderSize
	for za0001 := range z.API.Objects {
		s += 1 + 11 + msgp.StringPrefixSize + len(z.API.Objects[za0001].ObjectName) + 10 + msgp.StringPrefixSize + len(z.API.Objects[za0001].VersionID)
	}
	s += 7 + msgp.StringPrefixSize + len(z.API.Status) + 11 + msgp.IntSize + 3 + msgp.Int64Size + 3 + msgp.Int64Size + 10 + msgp.Int64Size + 16 + msgp.StringPrefixSize + len(z.API.TimeToFirstByte) + 20 + msgp.StringPrefixSize + len(z.API.TimeToFirstByteInNS) + 15 + msgp.StringPrefixSize + len(z.API.TimeToResponse) + 19 + msgp.StringPrefixSize + len(z.API.TimeToResponseInNS) + msgp.StringPrefixSize + len(z.RemoteHost) + msgp.StringPrefixSize + len(z.RequestID) + msgp.StringPrefixSize + len(z.UserAgent) + msgp.StringPrefixSize + len(z.ReqPath) + msgp.StringPrefixSize + len(z.ReqHost) + msgp.MapHeaderSize
	if z.ReqClaims != nil {
		for za0002, za0003 := range z.ReqClaims {
			_ = za0003
			s += msgp.StringPrefixSize + len(za0002) + msgp.GuessSize(za0003)
	...
	s += msgp.StringPrefixSize + len(z.AccessKey) + msgp.StringPrefixSize + len(z.ParentUser) + msgp.StringPrefixSize + len(z.Error)
	return
}

// DecodeMsg implements msgp.Decodable
func (z *AuditLogTupleList) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
	...
	for zb0001 > 0 {
		...
		case "entries":
			...
			if cap(z.Entries) >= int(zb0002) {
				...
				z.Entries = make([]AuditLogTuple, zb0002)
			}
			for za0001 := range z.Entries {
				err = z.Entries[za0001].DecodeMsg(dc)
				if err != nil {
...
// EncodeMsg implements msgp.Encodable
func (z *AuditLogTupleList) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "entries"
	err = en.Append(0x81, 0xa7, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73)
	if err != nil {
...
// MarshalMsg implements msgp.Marshaler
func (z *AuditLogTupleList) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "entries"
	o = append(o, 0x81, 0xa7, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *AuditLogTupleList) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *AuditLogTupleList) Msgsize() (s int) {
	s = 1 + 8 + msgp.ArrayHeaderSize
	for za0001 := range z.Entries {
		s += z.Entries[za0001].Msgsize()
	}
